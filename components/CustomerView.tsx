...
import { 
  ...
  Shield, Lock, Fingerprint, Zap, HelpCircle, Book, Mail, ExternalLink
} from 'lucide-react';
            ...
            />
             ...
             <div className="animate-in slide-in-from-right duration-300">
                ...
                <div className="space-y-6">
                        ...
                        <div className="space-y-3">
                            ...
                            >
                                <div className="flex items-center">
                                    ...
                                    <div className="text-left">
                                        <p className="text-sm font-bold text-gray-900 dark:text-white">Centre d'aide</p>
                                        <p className="text-[10px] text-gray-500">Guides et questions fréquentes</p>
                                    </div>
                                </div>
                            ...
                            >
                                <div className="flex items-center">
                                    ...
                                    <div className="text-left">
                                        <p className="text-sm font-bold text-gray-900 dark:text-white">Contacter le support</p>
                    ...
                    {user.role === 'client' && (
                        <div className="bg-gradient-to-br from-green-50 to-emerald-50 dark:from-green-900/20 dark:to-emerald-900/20 p-4 rounded-xl shadow-sm border border-green-100 dark:border-green-900/50">
                            <h3 className="font-bold text-green-900 dark:text-green-300 mb-2 flex items-center">
                                <Bike size={20} className="mr-2 text-green-600"/>
                                Gagnez de l'argent avec nous
                            </h3>
                            <p className="text-xs text-green-700 dark:text-green-400 mb-4 leading-relaxed">
                                Inscrivez-vous comme livreur et commencez à livrer des commandes dans votre ville.
                            </p>
                            <button 
                                onClick={() => {
