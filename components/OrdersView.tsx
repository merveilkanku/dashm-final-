                        ...
                        <div className="p-4">
                            ...
                            {isDelivering && (
                                <div className="animate-in fade-in slide-in-from-top-4 duration-500 mb-6">
                                    <div className="flex items-center justify-between mb-2">
                                        ...
                                        <span className="text-[10px] bg-brand-100 text-brand-600 px-2 py-0.5 rounded-full font-bold">Livreur à proximité</span>
                                    </div>
                                    <DeliveryTrackingMap 
                                        order={order} 
                            ...
                            {!isCompleted && !isCancelled && (
                                <div className="space-y-3">
                                    {/* Bouton de confirmation de réception (Toujours visible pour les commandes en cours) */}
                                    <button 
                ...
                <div className="bg-white rounded-2xl w-full max-w-sm relative z-10 overflow-hidden animate-in zoom-in-95 duration-200 shadow-2xl">
                    <div className="bg-brand-600 p-4 text-white text-center relative">
                        ...
                        <h3 className="text-xl font-black">
                            {confirmingOrder.paymentMethod === 'cash' ? 'Commande Reçue et Payée ?' : 'Commande Reçue ?'}
                        </h3>
                    ...
                    <form onSubmit={handleConfirmReceipt} className="p-6 space-y-4">
                        ...
                        >
                            {isSubmitting ? (
                                ...
                                confirmingOrder.paymentMethod === 'cash' ? 'Confirmer la réception et le paiement' : 'Confirmer la réception'
                            )}
                        </button>
                    </form>
                </div>
